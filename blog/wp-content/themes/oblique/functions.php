...
function oblique_footer_credits() {
	echo '<a href="' . esc_url( __( 'http://gentlers.club/', 'oblique' ) ) . '" rel="nofollow">';
		printf( __( 'Sitio desarrollado en %s', 'oblique' ), 'WordPress' );
	echo '</a>';
	echo '<span class="sep">  </span>';
	printf( __( 'Para Gentlers.', 'oblique' ), 'Gentlers', '<a href="http://themeisle.com/themes/oblique/" rel="nofollow">Oblique</a>' );
}
