  ...
  ================================= */
	...
	--------------------------------------------------------------------------*/
		...
		Kirki::add_section( 'homepage_testimonial', array(
  		...
  		Kirki::add_field( 'navthemes', array(
				'settings' => 'homepage_testimoial_client4',
				'label'    => __( 'Client 4', 'thewest' ),
				'section'  => 'homepage_testimonial',
				'type'     => 'text',
				'priority' => 10,
				'default'  => __('Client 4', 'thewest'), 
			 
		 ) );
		 
  		Kirki::add_field( 'navthemes', array(
				'settings' => 'homepage_testimoial_text4',
				'label'    => __( 'Testimonial 4', 'thewest' ),
				'section'  => 'homepage_testimonial',
				'type'     => 'textarea',
				'priority' => 10,
				'default'  => __('Pellentesque nulla magna, accumsan sed ante quis, gravida feugiat turpis.', 'thewest' ), 
